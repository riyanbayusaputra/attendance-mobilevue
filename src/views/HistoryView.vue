...
<template>
    <div class="min-h-screen bg-gray-50 pb-24">
        ...
        <div class="px-4 py-4 space-y-3">
            ...
            <template v-else>
                <div
                    v-for="item in presence.history"
                    :key="item.id"
                    class="bg-white rounded-2xl shadow-sm overflow-hidden"
                >
                    <div
                        class="px-4 pt-4 pb-3 flex items-center justify-between border-b border-gray-50"
                    >
                        <div>
                        ...
                        <div
                            v-if="item.check_in_at && item.check_out_at"
                            class="text-right"
                        >
